...
async function initSession() {
    try {
        // Используем динамический импорт, чтобы избежать ошибки при запуске
